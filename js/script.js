...
const albumsData = [
    ...
    },
    {
        ...
        genre: 'Trap',
        tracks: [
            { id: 0, name: 'REI TUÊ', duration: '2:23', audio: './audios/XTRNO/rei-tue.mpeg' },
            { id: 1, name: 'TALKING BOUT', duration: '2:32', audio: './audios/XTRNO/talking-boult.mpeg' },
            { id: 2, name: 'MEU CEMITÉRIO', duration: '3:27', audio: './audios/XTRNO/meu-cemiterio.mpeg' },
            { id: 3, name: 'ÍCONE FASHION', duration: '2:32', audio: './audios/XTRNO/icone-fashion.mpeg' },
            { id: 4, name: 'AUTOBAHN', duration: '3:05', audio: './audios/XTRNO/autobahn.mpeg' },
            { id: 5, name: 'NANANANA', duration: '0:43', audio: './audios/XTRNO/nananana.mpeg' },
            { id: 6, name: 'FACAS E MACHADOS', duration: '1:52', audio: './audios/XTRNO/facas-e-machados.mpeg' },
            { id: 7, name: 'ALTERADO', duration: '3:34', audio: './audios/XTRNO/alterado.mpeg' },
            { id: 8, name: 'PENSAMENTOS PERIGOSOS', duration: '3:30', audio: './audios/XTRNO/pensamento-perigosos.mpeg' },
            { id: 9, name: 'XTRANHO', duration: '3:33', audio: './audios/XTRNO/xtranho.mpeg' },
            { id: 10, name: 'BACKSTAGE', duration: '2:19', audio: './audios/XTRNO audios/XTRNO/backstage.mpeg' },
            { id: 11, name: 'TODAS AS LUZES', duration: '2:33', audio: './audios/XTRNO/todas-luzes.mpeg' },
            { id: 12, name: 'OS MELHORES', duration: '2:35', audio: './audios/XTRNO/os-melhores.mpeg' },
        ],
    },
];
...
const musicasEmAlta = [
    ...
    { name: 'JULIANA', artist: 'Alee & Klisman', img: './img/albuns/PQTFA.jpg', explicit: false, albumId: 0, audio: 'https://www.soundhelix.com/audio/mp3/SoundHelix-Song-10.mp3' },
...
const artistas = [
    { name: 'Matuê', img: './img/artistas/matue.jpg', albumId: 6 },
    { name: 'Klisman', img: './img/artistas/klisman.jpg', albumId: 2 },
    { name: 'Alee', img: './img/artistas/alee.jpg', albumId: 0 },
    { name: 'Teto', img: './img/artistas/teto.jpg', albumId: 3 },
    { name: 'Wiu', img: './img/artistas/wiu.jpg', albumId: 3 },
    { name: 'LPT Slatan', img: './img/artistas/lpt-slatan.jpg', albumId: 1 },
    { name: 'Ryu, The Runner', img: './img/artistas/ryu.jpg', albumId: null }, 
